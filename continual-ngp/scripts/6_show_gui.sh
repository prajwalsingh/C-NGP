...
#     --exp_name lego \
#     --scene_name continual_learning_nerf_synth_validation \
#     --scene_lst lego \
#     --batch_size=14000 \
#     --dataset_name=nerf \
#     --class_idx 1 \
...
#     --lr 2e-3 \
#     --val_only \
#     --ckpt_path "./ckpts/nerf/continual_learning_nerf_synth/conti_1_lego_chair_ship_drums_ficus_hotdog_materials_mic/epoch=29.ckpt"
...
#     --lr 2e-3 \
#     --val_only \
#     --ckpt_path "./ckpts/nerf/continual_learning_nerf_synth/conti_1_lego_chair_ship_drums_ficus_hotdog_materials_mic/epoch=29_slim.ckpt"
