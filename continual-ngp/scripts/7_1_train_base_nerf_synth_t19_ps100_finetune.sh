python train.py \
    ...
    --exp_name lego \
    --scene_name conti_1_lego_chair_ship_drums_ficus_hotdog_materials_mic_finetune_lego_finetune \
    --scene_lst lego \
    --batch_size=14000 \
    --dataset_name=nerf \
    --class_idx 1 \
    ...
    --lr 2e-3 \
    --previous_state 100 \
    --weight_path "./ckpts/nerf/continual_learning_nerf_synth/conti_1_lego_chair_ship_drums_ficus_hotdog_materials_mic/epoch=29.ckpt"
