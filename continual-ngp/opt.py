...
def get_opts():
    ...
    parser.add_argument('--hashfeatsize', type=int, default=4,
    ...
    parser.add_argument('--continual', action='store_true', default=False,
                        help='training network using continual learning')
    parser.add_argument('--previous_state', type=int, default=100,
                        help='number of sample to sampled from previous state')
